...
const SUB_FIXTURES: Array<LapseSubscription | null | undefined> = [
  ...
  { status: undefined },
  { status: "active" },
  { status: "active", trial_end: ANCHOR_ISO, current_period_end: ANCHOR_ISO, canceled_at: ANCHOR_ISO },
  ...
  { status: "trialing" },
  { status: "canceled", canceled_at: ANCHOR_ISO },
  ...
  { status: "canceled", canceled_at: "garbage", current_period_end: ANCHOR_ISO },
